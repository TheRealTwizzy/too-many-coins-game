...
class SimulationConfigPreflight
{
    ...
    private const SEASON_KEY_META = [
        ...
        'hoarding_window_ticks' => ['candidate_scope' => true, 'referenced' => false],
        'target_spend_rate_per_tick' => ['candidate_scope' => true, 'referenced' => false],
        ...
        'starprice_reactivation_window_ticks' => ['candidate_scope' => true, 'referenced' => false],
        'starprice_demand_table' => ['candidate_scope' => true, 'referenced' => false],
        'market_affordability_bias_fp' => ['candidate_scope' => true, 'referenced' => false],
        'vault_config' => ['candidate_scope' => true, 'referenced' => false],
