...
class TuningCandidateGenerator
{
    ...
    private static function versionProfiles(int $tuningVersion): array
    {
        $multiplierOverrides = [
            ...
            'boost_roi_imbalance' => [
                'target_spend_rate_per_tick' => ['conservative' => 0.95, 'balanced' => 0.87],
                'hoarding_min_factor_fp' => ['conservative' => 1.05, 'balanced' => 1.15],
            ],
            'phase_dead_zones' => [
                'hoarding_window_ticks' => ['conservative' => 0.95, 'balanced' => 0.88],
            ],
        ];
            ...
            'lock_in_support' => [
                ...
                'targets' => [
                    [
                        ...
                        'economy_effect' => 'Preserves lock-in viability when hoarding pressure rises.',
                    ],
                    [
                        ...
                        'type' => 'pricing',
                        'mechanic' => 'star_pricing',
                        'player_effect' => 'Stars stay slightly more affordable under drain pressure.',
        ...
        if ($tuningVersion >= 3) {
            $multiplierOverrides = [
                ...
                'boost_roi_imbalance' => [
                    'target_spend_rate_per_tick' => ['conservative' => 0.97, 'balanced' => 0.93],
                    'hoarding_min_factor_fp' => ['conservative' => 1.04, 'balanced' => 1.08],
                ],
                'phase_dead_zones' => [
                    'hoarding_window_ticks' => ['conservative' => 0.98, 'balanced' => 0.94],
                ],
            ];
            ...
            'sigil_scarcity' => [
                ...
                'targets' => [
                    [
                        ...
                        'conservative' => 'vault_supply_small',
                        'balanced' => 'vault_supply_medium',
                        'mode' => 'vault_tuning',
                        'type' => 'config_value',
                ...
                'escalation_partial' => [
                    'reason' => 'Drop rate constants are in config.php, not season columns.',
                    'subsystem' => 'sigil_drop_engine',
                    'runtime_path' => 'includes/config.php / includes/economy.php adjustedSigilTierOdds()',
                ],
            ],
            'sigil_overabundance' => [
                'tunable' => true,
                ...
                'targets' => [
                    [
                        ...
                        'conservative' => 'vault_supply_reduce_small',
                        'balanced' => 'vault_supply_reduce_medium',
                        'mode' => 'vault_tuning',
                        'type' => 'config_value',
                        'mechanic' => 'sigil_vault',
