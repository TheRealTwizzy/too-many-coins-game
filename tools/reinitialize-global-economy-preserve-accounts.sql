...
-- sigil_catalog, sigil_ability, boost_catalog and cosmetic_catalog are
-- definitions rather than state, exactly like cosmetic_catalog already was.
-- Truncating them would leave the game with no sigils to define.
-- ------------------------------------------------------------------
