-- Reinitialize season/tick economy state while preserving account/auth identity data.
--
...
--
-- Reset scope:
--   season pointers/flags on players + season-bound/runtime tables + server_state/yearly_state
--
-- Usage (example):
...
SELECT 'season_reinit_complete' AS status;
