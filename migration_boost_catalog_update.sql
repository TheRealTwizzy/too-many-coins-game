...
UPDATE boost_catalog SET name = 'Trickle', description = '', duration_ticks = 60,   modifier_fp = 100000, max_stack = 5, sigil_cost = 1 WHERE tier_required = 1;
...
UPDATE boost_catalog SET name = 'Flow',    description = '', duration_ticks = 360,  modifier_fp = 250000, max_stack = 2, sigil_cost = 1 WHERE tier_required = 3;
UPDATE boost_catalog SET name = 'Tide',    description = '', duration_ticks = 720,  modifier_fp = 500000, max_stack = 1, sigil_cost = 1 WHERE tier_required = 4;
