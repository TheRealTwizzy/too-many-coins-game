...
Generated: 2026-04-15T08:08:37+00:00
Seed: `balance-manual-base_ubi_idle_factor_fp-275000`
Overall status: `fail`
...
- Directional diagnostics:
  - `skip_strategy_edge` fail | baseline=4898.6666666667 candidate=4916.6666666667 delta=18 | skip_strategy_edge rose by 18; goal-facing improvement=-18 (need >= 0).
...
- Directional diagnostics:
  - `hoarder_advantage_gap` pass | baseline=9412 candidate=7780 delta=-1632 | hoarder_advantage_gap fell by 1632; goal-facing improvement=1632 (need >= 0).
  - `dominant_strategy_pressure` pass | baseline=0.82200295237355 candidate=0.76454205458741 delta=-0.057460897786141 | dominant_strategy_pressure fell by 0.057461; goal-facing improvement=0.057461 (need >= 0).
...
- Directional diagnostics:
  - `boost_roi` pass | baseline=24.191171088747 candidate=24.434583714547 delta=0.24341262580055 | boost_roi rose by 0.243413; goal-facing improvement=0.243413 (need >= 0).
...
- Directional diagnostics:
  - `star_purchase_density` pass | baseline=1967 candidate=2004.6666666667 delta=37.666666666667 | star_purchase_density rose by 37.666667; goal-facing improvement=37.666667 (need >= 0).
  ...
  - `star_price_range_ratio` fail | baseline=0.079546584468529 candidate=0.089463220675944 delta=0.009916636207415 | star_price_range_ratio rose by 0.009917; goal-facing improvement=-0.009917 (need >= 0).
