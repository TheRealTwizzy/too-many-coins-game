...
- Disposition: `reject`
- Generated: `2026-04-15T07:35:37+00:00`

## Control vs Baseline

- Wins: 6 | Losses: 9 | Mixed: 2
- Comparator note: Paired samples: 2 group comparisons across 2 simulator group(s).
- `B` B|ppa=2|seasons=1 | wins=3 losses=4 flags=dominant_archetype_shifted
- `C` C|ppa=2|seasons=4 | wins=3 losses=5 flags=long_run_concentration_worsened
...
- #1 `season.hoarding_safe_hours` | confidence=low | score=5.78
...
- #2 `season.hoarding_sink_enabled` | confidence=low | score=5.78
  rationale=Knob was active in the effective config. Its subsystem aligns with the primary failed gate. Bundle interaction ambiguity lowers confidence.
