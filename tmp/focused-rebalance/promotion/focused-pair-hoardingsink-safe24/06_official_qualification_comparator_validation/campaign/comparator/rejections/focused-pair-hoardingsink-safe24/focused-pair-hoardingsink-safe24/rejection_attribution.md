...
- Scenario: `focused-pair-hoardingsink-safe24`
- Disposition: `reject`
- Generated: `2026-04-15T16:16:57+00:00`

## Control vs Baseline

- Wins: 9 | Losses: 7 | Mixed: 2
- Comparator note: Paired samples: 2 group comparisons across 2 simulator group(s).
- `B` B|ppa=2|seasons=1 | wins=5 losses=2 flags=dominant_archetype_shifted
- `C` C|ppa=2|seasons=4 | wins=4 losses=5 flags=dominant_archetype_shifted, long_run_concentration_worsened
...
- #1 `season.hoarding_safe_hours` | confidence=low | score=6.545
...
- #2 `season.hoarding_sink_enabled` | confidence=low | score=6.545
  rationale=Knob was active in the effective config. Its subsystem aligns with the primary failed gate. Bundle interaction ambiguity lowers confidence.
