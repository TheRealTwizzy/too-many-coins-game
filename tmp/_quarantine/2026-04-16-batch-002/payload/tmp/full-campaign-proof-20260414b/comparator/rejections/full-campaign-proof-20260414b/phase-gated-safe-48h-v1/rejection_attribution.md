...
- Scenario: `phase-gated-safe-48h-v1`
- Disposition: `reject`
...
- `B` B|ppa=2|seasons=1 | wins=1 losses=5 flags=lock_in_down_but_expiry_dominance_up
...
- `season.hoarding_safe_hours` => active | baseline=12 | candidate=48
