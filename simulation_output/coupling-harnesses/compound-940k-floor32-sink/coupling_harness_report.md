...
Generated: 2026-04-15T23:09:58+00:00
Seed: `compound-940k-floor32-sink`
Overall status: `fail`
...
- Directional diagnostics:
  - `skip_strategy_edge` fail | baseline=5910 candidate=5910.6666666667 delta=0.66666666666697 | skip_strategy_edge rose by 0.666667; goal-facing improvement=-0.666667 (need >= 0).
...
- Directional diagnostics:
  ...
  - `dominant_strategy_pressure` fail | baseline=0.66144414168937 candidate=0.66151002140494 delta=6.5879715569372E-5 | dominant_strategy_pressure rose by 6.6E-5; goal-facing improvement=-6.6E-5 (need >= 0).
