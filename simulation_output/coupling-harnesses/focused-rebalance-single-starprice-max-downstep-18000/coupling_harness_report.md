...
Generated: 2026-04-15T16:02:43+00:00
Seed: `focused-rebalance-single-starprice-max-downstep-18000`
Overall status: `fail`
...
- Directional diagnostics:
  - `hoarder_advantage_gap` pass | baseline=9412 candidate=9322 delta=-90 | hoarder_advantage_gap fell by 90; goal-facing improvement=90 (need >= 0).
  - `dominant_strategy_pressure` pass | baseline=0.82200295237355 candidate=0.80975684355406 delta=-0.012246108819493 | dominant_strategy_pressure fell by 0.012246; goal-facing improvement=0.012246 (need >= 0).
...
- Directional diagnostics:
  - `boost_roi` fail | baseline=24.191171088747 candidate=24.180420860018 delta=-0.01075022872827 | boost_roi fell by 0.01075; goal-facing improvement=-0.01075 (need >= 0).
